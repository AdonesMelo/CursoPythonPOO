# Crie um controle remoto, onde vamos simular o fucionamento de uma controle simples.
...
c = ControleRemoto() # Instancia do controle remoto
# Menu de controle remoto
while True:
    c.mostrar_tv()
    opcao = str(input(f'< CH{c.canal_atual} >  + VOL{c.volume_atual} - '))
    match opcao:
        case '0':
            break
        case '@':
